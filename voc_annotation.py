...
river_path = 'G:\yemaolin\segformer-pytorch-master\datasets'
...
if __name__ == "__main__":
    ...
    segfilepath = os.path.join(river_path, 'SegmentationClass')
    saveBasePath = os.path.join(river_path, 'ImageSets/Segmentation')
