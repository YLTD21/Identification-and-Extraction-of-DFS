...
class MixVisionTransformer(nn.Module):
    def __init__(self, in_chans=3, num_classes=2, embed_dims=[32, 64, 160, 256],
        ...
        self.aspp1 = ASPP(in_channel=embed_dims[0], depth=64)  # 将 ASPP 模块加载到编码器最后一层
        ...
        self.aspp2 = ASPP(in_channel=embed_dims[1], depth=128)  # 将 ASPP 模块加载到编码器最后一层
        ...
        self.aspp3 = ASPP(in_channel=embed_dims[2], depth=320)  # 将 ASPP 模块加载到编码器最后一层
        ...
        self.aspp4 = ASPP(in_channel=embed_dims[3], depth=512)  # 将 ASPP 模块加载到编码器最后一层
